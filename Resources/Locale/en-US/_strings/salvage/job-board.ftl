...
# Pirate bounty names
salv-job-board-name-PirateBountyNuke = Nuclear weapon
salv-job-board-name-PirateBountyAnomVessel = Anomaly vessel
salv-job-board-name-PirateBountyArtifact = Artifact
salv-job-board-name-PirateBountyCrewMonitor = Crew monitor
salv-job-board-name-PirateBountyVendingMachine = Vending machine
salv-job-board-name-PirateBountyTelecom = Telecom server
salv-job-board-name-PirateBountyShuttleParts = Shuttle parts
salv-job-board-name-PirateBountyFaxmachine = Fax machine
salv-job-board-name-PirateBountyStasisBed = Stasis bed
salv-job-board-name-PirateBountyPDA = PDA
salv-job-board-name-PirateBountyExtinguisher = Fire extinguisher
salv-job-board-name-PirateBountyCaptainGloves = Captain's gloves
salv-job-board-name-PirateBountyGyro = Gyroscope
salv-job-board-name-PirateBountyDefib = Defibrillator
salv-job-board-name-PirateBountyAlcohol = Alcohol dispenser
salv-job-board-name-PirateBountyThruster = Thruster
salv-job-board-name-PirateBountyGravGen = Gravity generator
salv-job-board-name-PirateBountyHardsuits = Hardsuits
salv-job-board-name-PirateBountyRTG = RTG
salv-job-board-name-PirateBountySalvGas = Salvager gas masks
salv-job-board-name-PirateBountyRDHardsuit = Experimental RD hardsuit
salv-job-board-name-PirateBountyMK58 = MK58 pistols
salv-job-board-name-PirateBountyMachineBoard = Machine board
salv-job-board-name-PirateBountyHotplate = Hotplate
salv-job-board-name-PirateBountyMedicalFabBoard = Medical techfab board
salv-job-board-name-PirateBountyArtifactAnalyzer = Artifact analyzer
salv-job-board-name-PirateBountyHypo = Hypospray
salv-job-board-name-PirateBountyOreBox = Ore box
salv-job-board-name-PirateBountyAutolathe = Autolathe
salv-job-board-name-PirateBountyDiamond = Diamonds
salv-job-board-name-PirateBountyGold = Gold ingots
salv-job-board-name-PirateBountyPlasmaCanister = Plasma canisters
salv-job-board-name-PirateBountyHydroTray = Hydroponics trays
salv-job-board-name-PirateBountyEnforcer = Enforcer shotguns
