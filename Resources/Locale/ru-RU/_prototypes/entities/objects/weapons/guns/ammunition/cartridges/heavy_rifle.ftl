...
ent-CartridgeHeavyLightRiflePractice = патрон (7,62×54ммR)
    .desc = Классический винтовочный патрон 7,62ммR, используемый во множестве боевых винтовок, снайперских винтовок и средних пулемётов. Благодаря своей увеличенной дальности по сравнению с промежуточными патронами, он менее эффективен в тесных условиях космических кораблей и чаще применяется в наземных боях или в старом вооружении. Меловые патроны обычно не наносят вреда и применяются для тренировок.
ent-CartridgeHeavyLightRifleIncendiary = патрон (7,62×54ммR)
...
ent-CartridgeHeavyLightRifleUranium = патрон (7,62ммR)
