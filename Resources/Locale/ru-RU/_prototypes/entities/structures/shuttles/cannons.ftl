...
ent-ShuttleGunLongbow = BAL-127 "Лонгбоу"
    .desc = Длинноствольная стационарная автопушка. Для стрельбы необходим магазин 12.7мм.
    .suffix = НЕ МАППИТЬ
...
ent-ShuttleGunVympel = BAL-127-2 "Вымпел"
    .desc = Спаренная стационарная автопушка с ленточным питанием. Для стрельбы необходимо вручную загружать ленту патронов 12.7мм.
    .suffix = НЕ МАППИТЬ
