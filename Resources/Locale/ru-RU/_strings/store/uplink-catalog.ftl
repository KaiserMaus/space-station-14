...
uplink-pistol-viper-desc = Небольшой, легко скрываемый, но маломощный пистолет. Оснащён полностью автоматическим ресивером. Использует патроны калибра 9мм.
...
# Ammo
uplink-pistol-magazine-name = Пистолетный магазин (9мм)
uplink-pistol-magazine-desc = Пистолетный магазин на 10 патронов. Совместим с "Гадюкой".
uplink-pistol-magazine-c20r-name = Магазин ПП (9мм)
...
uplink-sniper-ammo-name = Коробка патронов (12,7мм антиматериальные)
