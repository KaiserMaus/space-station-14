...
uplink-estoc-ammo-desc = Магазин для Estoc DMR на 25 патронов. Совместим с Estoc DMR.
## Weapon (Sunrise)
...
uplink-clothing-backpack-syndie-aj100-desc = Включает в себя пистолет-пулемёт AJ-100 что имеет универсальную шахту магазина и может использовать большинство магазинов для ПП и пистолетов и два магазина безгильзовых патрон в наборе.
