...
access-system-accesses-delay-martial-law = Зафиксировано установление военного положения! Запущен протокол автоматической перезаписи доступов. Все мобилизованные получат расширенный доступ через { $time } секунд.
