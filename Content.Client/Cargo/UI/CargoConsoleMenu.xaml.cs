    ...
    public sealed partial class CargoConsoleMenu : FancyWindow
    {
        ...
        public CargoConsoleMenu(EntityUid owner, IEntityManager entMan, IPrototypeManager protoManager, SpriteSystem spriteSystem)
        {
            ...
            TransferSpinBox.IsValid = val =>
            {
                ...
                return val >= 0 && val <= (int) (console.TransferLimit * bank.Accounts.GetValueOrDefault(console.Account)); // Sunrise-edit
            };
            ...
            foreach (var prototype in products)
            {
                    ...
                    search.Length == 0 && _category != null && Loc.GetString(prototype.Category).Equals(_category))
                {
                    var button = new CargoProductRow
                    {
                        ...
                        Icon = { Texture = GetProductIcon(prototype) },
                    };
        ...
        private Texture GetProductIcon(CargoProductPrototype prototype)
        {
            if (prototype.Icon is SpriteSpecifier.Rsi icon &&
                icon.RsiPath.ToString().Contains("piratechest", StringComparison.OrdinalIgnoreCase))
                return _spriteSystem.GetPrototypeIcon(prototype.Product).Default;

            return _spriteSystem.Frame0(prototype.Icon);
        }
