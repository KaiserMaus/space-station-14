...
public sealed class EmagSystem : EntitySystem
{
    ...
    public bool TryEmagEffect(Entity<EmagComponent?> ent, EntityUid user, EntityUid target, EmagType? customEmagType = null)
    {
        ...
        var emaggedEvent = new GotEmaggedEvent(user, typeToUse, ent.Owner); // Sunrise Edit
...
[ByRefEvent]
public record struct GotEmaggedEvent(EntityUid UserUid, EmagType Type, EntityUid? EmagUid = null, bool Handled = false, bool Repeatable = false); // Sunrise Edit
